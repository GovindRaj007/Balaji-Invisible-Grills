...
function ContactPage() {
  ...
  return (
    <>
      ...
      <section className="container-x py-10 md:py-16 grid lg:grid-cols-[1fr_1.1fr] gap-12">
        <div>
          ...
          <div className="mt-8 space-y-3">
            ...
            <a href={`mailto:${BUSINESS.email}`} className="card-surface flex items-center gap-4 !p-5">
            ...
            <form className="grid gap-4" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <label className="grid gap-1.5 text-sm">
                  ...
                  <input required className="px-3.5 py-2.5 rounded-lg border border-input bg-background" placeholder="Your name" />
                </label>
                <label className="grid gap-1.5 text-sm">
                  <span className="font-medium">Phone *</span>
                  <input required type="tel" className="px-3.5 py-2.5 rounded-lg border border-input bg-background" placeholder="+91" />
                </label>
              </div>
              <label className="grid gap-1.5 text-sm">
                <span className="font-medium">Email</span>
                <input type="email" className="px-3.5 py-2.5 rounded-lg border border-input bg-background" placeholder="you@example.com" />
              </label>
              <div className="grid sm:grid-cols-2 gap-4">
                <label className="grid gap-1.5 text-sm">
                  <span className="font-medium">Service *</span>
                  <select required className="px-3.5 py-2.5 rounded-lg border border-input bg-background">
              ...
              <label className="grid gap-1.5 text-sm">
                ...
                <textarea rows={4} className="px-3.5 py-2.5 rounded-lg border border-input bg-background" placeholder="Balcony size, number of windows, timeline…" />
              </label>
              <button type="submit" className="btn-primary justify-center mt-2"><Send className="size-4" /> Request Free Quote</button>
